<?php
/**
 * dashboard.php — Vista principal (Menú de Selección)
 * 
 * Es la puerta de entrada para los usuarios logueados. Sirve como un hub
 * que segmenta las funciones según el rol asignado.
 */
...
<head>
    ...
    <!-- Inyección dinámica de configuración Tailwind y Animaciones Globales -->
...
<body class="bg-gray-50 min-h-screen text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <!-- Encabezado de Bienvenida con Animación Dinámica -->
        ...
        <!-- Rejilla de Acciones: Se ajusta automáticamente si el usuario es Admin o Regular -->
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo Auth::isAdmin() ? '4' : '2'; ?> gap-8 max-w-<?php echo Auth::isAdmin() ? '7xl' : '4xl'; ?> mx-auto">
            ...
            <!-- TARJETA: CREAR SOLICITUD (Visible para todos) -->
            ...
            <!-- TARJETA: MIS SOLICITUDES (Visualización propia) -->
            ...
            <?php if (Auth::isAdmin()): ?>
                <!-- TARJETA: PANEL REVISOR (Solo para personal de auditoría) -->
                ...
                <!-- TARJETA: ESTADÍSTICAS (Métricas globales de la institución) -->
